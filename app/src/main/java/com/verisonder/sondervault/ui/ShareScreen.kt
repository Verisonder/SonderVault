...
import com.verisonder.sondervault.bundle.Bundle
import com.verisonder.sondervault.bundle.BundleWriter
...
fun ShareScreen(
    ...
    val fileName = if (isBackup) "sondervault-backup-$stamp" else "sondervault-$stamp"
